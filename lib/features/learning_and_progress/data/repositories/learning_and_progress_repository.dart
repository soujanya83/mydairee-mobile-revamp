...
class LearningAndProgressRepository {
  ...
  // // }
  Future<List<ChildModel>> fetchChildrenData(String centerId, String roomId) async {
    List<ChildModel> data = [];
    await getAndParseData(
      '${AppUrls.baseUrl}/api/learningandprogress/index?centerid=$centerId&room_id=$roomId',
      fromJson: (json) {
        try {
